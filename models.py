...
class GenericMenuModel(CMSPlugin):
    ...
    extra_inactive = models.PositiveIntegerField(default = 0, help_text = "Level of navigation to be displayed if a node is not a direct ancestor or decendent of the current active node. 0 is root level.")
