...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SelectiveMenuModel.depth'
        db.add_column(u'amenu_selectivemenumodel', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SelectiveMenuModel.depth'
        db.delete_column(u'amenu_selectivemenumodel', 'depth')
