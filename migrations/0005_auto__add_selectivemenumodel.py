...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'amenu_selectivemenumodel', (
            ...
            ('depth', self.gf('django.db.models.fields.PositiveIntegerField')(default=100)),
        ))
        db.send_create_signal(u'amenu', ['SelectiveMenuModel'])

        # Adding M2M table for field pages on 'SelectiveMenuModel'
        m2m_table_name = db.shorten_name(u'amenu_selectivemenumodel_pages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('selectivemenumodel', models.ForeignKey(orm[u'amenu.selectivemenumodel'], null=False)),
            ('page', models.ForeignKey(orm['cms.page'], null=False))
        ))
        db.create_unique(m2m_table_name, ['selectivemenumodel_id', 'page_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field pages on 'SelectiveMenuModel'
        db.delete_table(db.shorten_name(u'amenu_selectivemenumodel_pages'))
    ...
    models = {
        ...
        u'amenu.selectivemenumodel': {
            ...
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'depth': ('django.db.models.fields.PositiveIntegerField', [], {'default': '100'}),
