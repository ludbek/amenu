...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuBelowThisModel.display_menu_heading'
        db.add_column(u'amenu_menubelowthismodel', 'display_menu_heading',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MenuBelowThisModel.display_menu_heading'
        db.delete_column(u'amenu_menubelowthismodel', 'display_menu_heading')
